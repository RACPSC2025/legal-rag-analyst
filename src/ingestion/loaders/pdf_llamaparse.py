...
class LlamaParsePDFLoader(BasePDFLoader):
    ...
    @property
    def name(self) -> str:
        return "LlamaParse High-Quality Engine"
...
def get_llamaparse_loader(**kwargs) -> LlamaParsePDFLoader:
    """Factory function para obtener loader LlamaParse."""
    return LlamaParsePDFLoader(**kwargs)
