...
def load_pdfs(
    paths: List[str | Path], 
    loader_type: LoaderType | str, 
    **kwargs
) -> List[Document]:
    """
    Carga y procesa múltiples PDFs usando el motor especificado.
    
    Args:
        paths: Lista de rutas a archivos PDF.
        loader_type: Tipo de motor a utilizar.
        **kwargs: Parámetros adicionales para el loader.
        
    Returns:
        Lista de fragmentos (Document) procesados.
    """
